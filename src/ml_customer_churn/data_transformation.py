...
class DataTransformation:
    ...
    def data_transformation(
        ...
        try:
            ...
            artifact_store.save(X_train_df, subdir=transform_path, name=xtrain_filename)
            artifact_store.save(X_test_df, subdir=transform_path, name=xtest_filename)
            artifact_store.save(y_train_df, subdir=transform_path, name=ytrain_filename)
            artifact_store.save(y_test_df, subdir=transform_path, name=ytest_filename)
            artifact_store.save(
                preprocessor, subdir=transform_path, name=transformer_filename
            )
